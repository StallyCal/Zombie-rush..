...
function preload()
{
  ...
  infAlertSnd = loadSound("infAlert.mp3");
  gameOverSnd = loadSound("gameOverSnd.wav")
...
fill ("red")
textSize (26)
text ("YOU WIN.....YOU HAVE GATHERED",200,300)
text ("FOOD SUPLIES FOR THE VILLAGE",200,330)
}
